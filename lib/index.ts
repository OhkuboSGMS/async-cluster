...
/**
 * Master distribute work to worker.
 * @param workQueue
 * @param workers
 * @param option
 */
function masterWork(workQueue: any[], workers: cluster.Worker[], option?: Partial<Option>): Promise<any> {
